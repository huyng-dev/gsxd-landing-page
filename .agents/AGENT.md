...
Registry:
- ".agents/skills/terminal-problem-logger/SKILL.md" | terminal-driven work with repeated failures | create a new incident note in .agents/problems after repeated failure loops and redact probable secrets
- ".agents/skills/powershell-windows/SKILL.md" | running PowerShell commands | use correct PowerShell syntax and safe command patterns
- ".agents/skills/regex-expert/SKILL.md" | crafting or debugging regex | produce precise and tested regex patterns
